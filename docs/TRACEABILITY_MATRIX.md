...
| PCS-OPS-004 | implementation complete / CI evidence pending | `ROLLBACK_RUNBOOK_v0.1.md`, release policy | separate app/DB/model/content/asset/share-template rollback, forward-fix DB default, affected-result handling | release-operations validator | deployment-provider commands/restore rehearsal remain adjacent OPS evidence |
