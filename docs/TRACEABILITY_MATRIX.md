...
| PCS-A11Y-002 | advanced partial | semantic progress/radiogroup/error/meter + accessible palette + focus/reduced-motion/touch + 200% scaling regression | axe WCAG A/AA, 44px target, touch/mobile, focus/motion and large-text E2E; manual release template exists | CI Run 329 baseline + current full CI | real screen-reader/assistive-tech and executed browser/mobile scaling review remain |
