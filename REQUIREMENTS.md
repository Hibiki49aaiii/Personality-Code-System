...
- [ ] **PCS-LEGAL-001** Privacy/terms/diagnostic limitations/data deletion-retention explanation before public launch. *(Implementation-grounded factual disclosure, self-deletion and 30/90/180-day cleanup exist. CI now proves logical restore integrity, but the policy correctly treats older-backup resurrection of later-deleted diagnostic/share data as unresolved until an independently durable deletion journal/equivalent and provider restore procedure exist; final jurisdiction/legal/contact/consent review remains open.)*
